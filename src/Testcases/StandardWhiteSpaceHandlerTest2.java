...
public class StandardWhiteSpaceHandlerTest2 {
	...
	public void test() {
		TokenizerProperties TP = new TokenizerProperties() {
			...
			StandardWhitespaceHandler whitetest = new StandardWhitespaceHandler(TP);
			boolean result = whitetest.newlineIsWhitespace("Software-Testing");
