...
public class StandardTokenizerTest1 {
	...
	public void test() throws TokenizerException {
		...
		StandardTokenizer tokenizertest = new StandardTokenizer(TP);
		TokenizerSource TS = new TokenizerSource() {
